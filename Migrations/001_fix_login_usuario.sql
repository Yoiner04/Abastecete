-- =============================================
-- Migración: 001_fix_login_usuario.sql
-- Fecha: 2025-12-15
-- Descripción: Corrige problemas de lógica en el procedimiento login_usuario
--
-- PROBLEMAS CORREGIDOS:
-- 1. El procedimiento actual no retorna resultado cuando estado_usuario != 1
-- 2. Falta validación para usuario inhabilitado (ESTADO = 97)
-- 3. No se limpia correctamente la variable contrasenia_correcta
-- 4. Falta índice en NOMBRE_USUARIO para mejorar rendimiento
-- =============================================
...
-- Agregar índice para mejorar rendimiento en búsqueda por nombre de usuario
-- NOTA: Ejecutar manualmente si no existe el índice:
-- CREATE INDEX idx_usuario_nombre ON usuario(NOMBRE_USUARIO);
--
-- O verificar primero:
-- SHOW INDEX FROM usuario WHERE Key_name = 'idx_usuario_nombre';
