-- =============================================
-- Migración 043: Corregir SP obtener_limites_membresia (FINAL)
-- Fecha: 2025-12-21
-- Problemas corregidos:
--   1. producto NO tiene FK_ID_LOCAL → usar productoslocal
--   2. productoslocal usa FK_ESTADO (no ESTADO)
--   3. oferta_flash usa ESTADO_OFERTA_FLASH, TIEMPO_OFERTA_FLASH, FECHA_OFERTA_FLASH
-- =============================================
