-- =============================================
-- Migracion: 015_actualizar_sp_producto.sql
-- Fecha: 2025-12-18
-- Descripcion: Actualizar stored procedures de productos con nuevos campos
-- =============================================
...
-- =============================================
-- SP: consultar_producto (mejorado con JOIN a marca)
-- =============================================
...
-- =============================================
-- SP: consultar_productos_todos (incluye categoria y subcategoria)
-- =============================================
...
-- =============================================
-- SP: consultar_productos_subcategoria (mejorado)
-- =============================================
...
-- =============================================
-- SP: crear_producto (con nuevos campos)
-- =============================================
...
-- =============================================
-- SP: editar_producto (con nuevos campos)
-- =============================================
...
-- =============================================
-- SP: consultar_productos_por_marca
-- =============================================
...
-- =============================================
-- SP: buscar_productos (para el admin)
-- =============================================
...
SELECT 'Migracion 015 completada - Stored procedures de producto actualizados' AS resultado;
