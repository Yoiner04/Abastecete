-- ============================================================
-- Migración 003: Corregir SP crear_local (p_fk_id_persona -> p_fk_id_usuario)
-- ============================================================
-- El SP usaba p_fk_id_persona que ya no existe (tabla persona eliminada)
-- La tabla local ya tiene FK_ID_USUARIO, solo falta actualizar el SP
-- ============================================================
...
SELECT 'MIGRACIÓN 003 - SP crear_local corregido (usa FK_ID_USUARIO)' as info;
