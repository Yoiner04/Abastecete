-- =============================================
-- Migración 042: Corregir SP obtener_limites_membresia
-- Fecha: 2025-12-21
-- Problema: Nombres de columnas incorrectos en oferta_flash
--           - ESTADO_OFERTA_FLASH (no ESTADO)
--           - TIEMPO_OFERTA_FLASH (no FECHA_EXPIRACION)
--           - FECHA_OFERTA_FLASH (no FECHA_CREACION)
-- =============================================
...
BEGIN
    ...
    -- Contar ofertas flash activas (usando nombres correctos de columnas)
