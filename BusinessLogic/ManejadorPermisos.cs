...
namespace BusinessLogic
{
    public class ManejadorPermisos
    {
        ...
        #region Métodos Legacy (Sistema Antiguo - Mantener para compatibilidad temporal)

        [Obsolete("Usar ObtenerPermisosUsuario en su lugar")]
        ...
        [Obsolete("Sistema de roles eliminado")]
        ...
        #region Nuevo Sistema de Permisos Unificado
