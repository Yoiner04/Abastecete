            ...
            string action)
        {
            try
            {
                var parametros = new List<Parametro>
                {
                    ...
                    new Parametro("p_datos_anteriores", !string.IsNullOrEmpty(datosAnteriores) ? (object)datosAnteriores : DBNull.Value),
                    new Parametro("p_datos_nuevos", !string.IsNullOrEmpty(datosNuevos) ? (object)datosNuevos : DBNull.Value),
                ...
                return conexion.EjecutarTransaccion("insertar_log_sistema", parametros);
            }
            catch (Exception ex)
            {
